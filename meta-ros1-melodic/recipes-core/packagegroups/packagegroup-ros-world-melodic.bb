...
# ERROR: Nothing RPROVIDES 'UNRESOLVED-python-pydot' (but generated-recipes/py-trees/py-trees_0.6.8.bb RDEPENDS on or otherwise requires it)
RDEPENDS_${PN}_remove = "py-trees"
RDEPENDS_${PN}_remove = "rqt-py-trees"
